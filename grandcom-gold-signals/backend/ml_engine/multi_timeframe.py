...
class MultiTimeframeAnalyzer:
    ...
    def _analyze_h1_structure(self, df: pd.DataFrame) -> Dict[str, Any]:
        ...
        try:
            ...
            broke_high = price > swing_high * 0.999
            broke_low = price < swing_low * 1.001
            ...
            return {
                ...
                'key_levels': {
                    'resistance': round(float(swing_high), 2),
                    'support': round(float(swing_low), 2),
                    'pivot': round(float((swing_high + swing_low) / 2), 2)
                }
            }
