...
class SignalOptimizer:
    ...
    def _optimize_levels(
        ...
        if regime == MarketRegime.HIGH_VOLATILITY:
            sl_mult = pair_params.get('atr_multiplier_sl', 1.5) * 1.3
            tp_mult_1 = pair_params.get('atr_multiplier_tp1', 0.05) * 0.8
            tp_mult_2 = pair_params.get('atr_multiplier_tp2', 0.10) * 0.9
            tp_mult_3 = pair_params.get('atr_multiplier_tp3', 0.15) * 0.9
        elif regime == MarketRegime.LOW_VOLATILITY:
            sl_mult = pair_params.get('atr_multiplier_sl', 1.5) * 0.8
            tp_mult_1 = pair_params.get('atr_multiplier_tp1', 0.05) * 1.2
            tp_mult_2 = pair_params.get('atr_multiplier_tp2', 0.10) * 1.2
            tp_mult_3 = pair_params.get('atr_multiplier_tp3', 0.15) * 1.2
        else:
            sl_mult = pair_params.get('atr_multiplier_sl', 1.5)
            tp_mult_1 = pair_params.get('atr_multiplier_tp1', 0.05)
            tp_mult_2 = pair_params.get('atr_multiplier_tp2', 0.10)
            tp_mult_3 = pair_params.get('atr_multiplier_tp3', 0.15)
