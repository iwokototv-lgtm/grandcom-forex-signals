...
class SignalOptimizer:
    ...
    def _optimize_levels(
        ...
        regime = regime_result['regime']
        decimal_places = pair_params.get('decimal_places', 2)
        
        if regime == MarketRegime.HIGH_VOLATILITY:
            sl_mult = pair_params.get('atr_multiplier_sl', 0.4) * 1.3
            tp_mult_1 = pair_params.get('atr_multiplier_tp1', 0.5) * 0.8
            tp_mult_2 = pair_params.get('atr_multiplier_tp2', 1.0) * 0.9
            tp_mult_3 = pair_params.get('atr_multiplier_tp3', 1.5) * 0.9
        elif regime == MarketRegime.LOW_VOLATILITY:
            sl_mult = pair_params.get('atr_multiplier_sl', 0.4) * 0.8
            tp_mult_1 = pair_params.get('atr_multiplier_tp1', 0.5) * 1.2
            tp_mult_2 = pair_params.get('atr_multiplier_tp2', 1.0) * 1.2
            tp_mult_3 = pair_params.get('atr_multiplier_tp3', 1.5) * 1.2
        else:
            sl_mult = pair_params.get('atr_multiplier_sl', 0.4)
            tp_mult_1 = pair_params.get('atr_multiplier_tp1', 0.5)
            tp_mult_2 = pair_params.get('atr_multiplier_tp2', 1.0)
            tp_mult_3 = pair_params.get('atr_multiplier_tp3', 1.5)
