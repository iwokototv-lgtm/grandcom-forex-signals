...
class RiskManager:
    ...
    def __init__(self, config: Optional[Dict] = None):
        self.config = config or {
            ...
            'monthly_drawdown_cap': 0.12,
            'max_usd_exposure': 0.30,
            'max_jpy_exposure': 0.25,
            'max_gold_exposure': 0.25,
            'max_crypto_exposure': 0.15,
    ...
    def calculate_position_size(
        ...
        try:
            ...
            if drawdown_pct > 0.05:
                drawdown_factor = 1 - (drawdown_pct * 2)
            ...
            pip_risk = price_risk / entry_price
