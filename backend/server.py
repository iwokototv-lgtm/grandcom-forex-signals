...
GOLD_PAIRS                = []  # Gold pairs not generated by this service (handled by serene-growth service)
...
async def generate_signal_for_pair(pair: str) -> Optional[Signal]:
    ...
    try:
        ...
        # Forex → 1H (SWING)  |  Scalp → 15min
        pair_strategy  = params.get("strategy", "SWING")
        ...
        early_threshold = max(strat_min_conf, MIN_CONFIDENCE_THRESHOLD)
