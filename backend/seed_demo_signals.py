...
async def seed_signals():
    ...
    signals = [
        ...
        },
        {
            ...
            "sl_price": 1.0870,
            "confidence": 92.8,
            "analysis": "EUR showing weakness against USD. Bearish divergence on RSI. Breaking below key support at 1.0850. Strong resistance at 1.0870. ECB dovish signals weighing on EUR. High probability 4H swing setup.",
            "timeframe": "4H",
            "risk_reward": 2.1,
            "status": "ACTIVE",
            "is_premium": True,
